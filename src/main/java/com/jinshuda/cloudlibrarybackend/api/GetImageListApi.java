...
public class GetImageListApi {
     ...
     * @return
     */
    public static List<ImageSearchVO> getImageList(String url) {
        try {
            // 发起GET请求  
     ...
     */
    private static List<ImageSearchVO> processResponse(String responseBody) {
        // 解析响应对象  
    ...
    public static void main(String[] args) {
        ...
        List<ImageSearchVO> imageList = getImageList(url);
